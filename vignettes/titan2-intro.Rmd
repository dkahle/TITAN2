...
documentations with `?plotSumz` or `?plot_sumz_density`. An abbreviated version
...
For `plotSumz`, the older plotting function in **TITAN2**, filled and hollow
...
summed PDFs are meant to provide complementarity to the `plotSumz()` graphic
